...
import { fontNunito, fontOpenSans } from "@/lib/fonts"
...
export const metadata: Metadata = {
  // Each page sets its own title from Strapi SEO; this is only the fallback,
  // and there is no suffix template because those titles already carry the
  // clinic name.
