...
import RatingSection from "@/app/[locale]/dev/showcase/components/sections/RatingSection"
...
import MockedStrapiContacts from "@/app/[locale]/dev/showcase/components/strapiComponents/MockedStrapiContacts"
import MockedStrapiCTABanner from "@/app/[locale]/dev/showcase/components/strapiComponents/MockedStrapiCTABanner"
import MockedStrapiDoctors from "@/app/[locale]/dev/showcase/components/strapiComponents/MockedStrapiDoctors"
...
import MockedStrapiWhyUs from "@/app/[locale]/dev/showcase/components/strapiComponents/MockedStrapiWhyUs"
...
export const showcaseItems = [
  ...
  },
  {
    ...
    description: "Review score with stars, used in the footer",
  },
  {
    id: "card",
    label: "Card",
  ...
  },
  {
    ...
    label: "Hero (collage)",
    kind: "component",
    component: MockedStrapiHeroCollage,
    description: "Hero variant with copy on the left and an image collage",
  },
  {
    id: "faq",
    label: "FAQ",
  ...
  },
  {
    ...
    label: "Contacts",
    kind: "component",
    component: MockedStrapiContacts,
    description: "Clinic address, phones and email with tap-to-call links",
  },
  {
    id: "why-us",
    label: "Why Us",
  ...
  },
  {
    ...
    label: "Services",
    kind: "component",
    component: MockedStrapiServices,
    description: "Grid of clinic services with icon, description and link",
  },
  {
    id: "doctors",
    label: "Doctors",
    kind: "component",
    component: MockedStrapiDoctors,
    description: "Grid of clinic doctors with photo, name and specialty",
  },
  {
    id: "results",
    label: "Results",
    kind: "component",
    component: MockedStrapiResults,
    description: "Before/after treatment cases with an optional caption",
  },
  {
    id: "testimonials",
    label: "Testimonials",
    kind: "component",
    component: MockedStrapiTestimonials,
    description: "Patient quotes with author name and photo",
  },
  {
    id: "features-list",
    label: "Features List",
