...
- **Integrations** — [Observability](../reference/integrations/logging.md) (structured logging, Sentry), and [reCAPTCHA](../reference/integrations/recaptcha.md) setup have dedicated reference pages.
