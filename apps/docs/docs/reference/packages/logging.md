...
logger.warn("Revalidation skipped", { reason: "missing token" })
...
external API calls, cache revalidation, email sending, and webhook
...
- [Observability](../integrations/logging.md) — pluggable telemetry backends (Sentry)
