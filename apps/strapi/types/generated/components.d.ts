...
export interface FormsLeadForm extends Struct.ComponentSchema {
  collectionName: "components_forms_lead_forms"
  info: {
    description: ""
...
export interface SharedContactItem extends Struct.ComponentSchema {
  ...
  attributes: {
    ...
    values: Schema.Attribute.Component<"utilities.text", true>
  }
}

export interface SectionsDoctors extends Struct.ComponentSchema {
...
export interface SharedRating extends Struct.ComponentSchema {
  ...
  attributes: {
    ...
    score: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<{ max: 5; min: 0 }, number>
  }
}
